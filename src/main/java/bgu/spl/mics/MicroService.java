...
public abstract class MicroService implements Runnable {
    ...
    private final ConcurrentHashMap<Class<? extends Message>, Callback<?>> callbacks = new ConcurrentHashMap<>(); //every type of message has callback
    ...
    public final void run() {
        ...
        try {
            ...
            System.err.println("MicroService " + name + " was interrupted."); //for testing - will be deleted
